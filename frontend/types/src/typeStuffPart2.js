...
// in javascript, typeof is not that specific as it will spit out object for {}, [],
let num1 = 42;
let num2: typeof num1 = 3.14;
let num3: typeof num1 = 'world'; // error

// Flow lets you use any value with typeof
let obj1 = {
  foo: 1,
  bar: true,
  baz: 'three',
...
// Kind of like a personal assert
let valuez = 42;
(valuez: 42);
(valuez: number);
(valuez: string); // error
